...
const Navbar = () => {
    ...
    return (
        <>
            <div className="navbar  top-0 flex items-center left-10 space-x-10 md:space-x-40 w-fit fixed z-10 justify-evenly my-8">
                <div className="left">
                ...
                <div>
                    <ul className="sm:flex space-x-5 font-bold hidden md:space-x-10 md:flex md:flex-row">
